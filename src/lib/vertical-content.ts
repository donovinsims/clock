...
export const VERTICAL_CONTENT: Record<string, VerticalContent> = {
  hvac: {
    ...
    steps: [
      { title: "Audit", body: "We trace a real call through your business — phone tree, CRM, dispatch, invoice — and find every drop-off." },
      { title: "Build", body: "We install an AI front desk, missed-call rescue, quote follow-ups, and review pipelines into your existing stack." },
      { title: "Handover", body: "You own every piece. Logins, docs, workflows. We train your office manager in one session." },
    ],
    automations: [
      { title: "24/7 AI front desk", body: "Answers, qualifies, books, and dispatches based on your real schedule." },
      { title: "Missed-call rescue", body: "Texts back within 30 seconds with a booking link and ETA." },
      { title: "Quote follow-up engine", body: "Multi-touch SMS + email sequence that recovers 20–35% of unsigned quotes." },
      { title: "Review pipeline", body: "Auto-triggers after job completion. Routes 5-star to Google, anything less to you privately." },
      { title: "Tune-up reactivation", body: "Wakes up dormant maintenance customers two weeks before season hits." },
      { title: "Tech dispatch dashboard", body: "Live job board with auto-routing and per-tech revenue tracking." },
    ],
    proof: {
  ...
  roofing: {
    ...
    steps: [
      { title: "Audit", body: "We trace your funnel from storm map to signed contract and quantify every gap in dollars." },
      { title: "Build", body: "We install AI lead response, claim tracking, canvasser logging, and referral payouts." },
      { title: "Handover", body: "Crews, sales, and ops trained in one afternoon. You own every workflow." },
    ],
    automations: [
      { title: "60-second lead response", body: "AI texts, qualifies, and books an inspection before the lead cools." },
      { title: "Insurance claim tracker", body: "Auto-updates the homeowner at every adjuster milestone so you stay the trusted contact." },
      { title: "Canvasser CRM", body: "One-tap door logging from the field, auto-routed to a sales follow-up sequence." },
      { title: "Storm radar to ad spend", body: "Triggers geo-fenced ads and door routes off real weather events." },
      { title: "Referral payout system", body: "Tracks, attributes, and pays referrers automatically." },
      { title: "Production status portal", body: "Homeowners see real-time progress without calling the office." },
    ],
    proof: {
      headline: "A Florida roofer closed 22% more inspections after we cut lead response to 47 seconds.",
  ...
  plumbing: {
    ...
    steps: [
      { title: "Audit", body: "We pressure-test your phone tree, dispatch, and follow-up. Every leak gets a dollar amount." },
      { title: "Build", body: "AI receptionist, on-call rotation logic, and reactivation flows installed into your CRM." },
      { title: "Handover", body: "Trained, documented, owned. No monthly fee." },
    ],
    automations: [
      { title: "After-hours AI dispatch", body: "Routes emergencies to the on-call tech in 30 seconds, with confirmed ETA texted to the homeowner." },
      { title: "Quote-to-job recovery", body: "Three-touch SMS + email flow that pulls 25%+ of unsigned quotes back to the schedule." },
      { title: "Past-customer reactivation", body: "Wakes up customers who haven't called in 12+ months with a maintenance offer." },
      { title: "Review engine", body: "Triggers a friction-free Google review request the moment payment clears." },
      { title: "Permit + inspection tracker", body: "Removes the office back-and-forth on every permitted job." },
      { title: "Tech KPI dashboard", body: "Per-tech revenue, close rate, and average ticket — updated daily." },
    ],
    proof: {
      headline: "An Atlanta plumbing shop added $26K in monthly emergency revenue without hiring a dispatcher.",
  ...
  electrical: {
    ...
    steps: [
      ...
      { title: "Build", body: "AI quote follow-up, permit tracking, and reactivation sequences shipped into your CRM." },
      { title: "Handover", body: "Your team owns it. No retainer. No license fee." },
    ],
    automations: [
      { title: "Quote follow-up sequence", body: "Multi-touch SMS + email that recovers 20–30% of unsigned bids." },
      { title: "Permit + inspection tracker", body: "Tracks every permit, nudges the inspector, updates the homeowner." },
      { title: "Service-to-upgrade nurture", body: "Converts small repair jobs into panel, EV charger, and rewire upgrades." },
      { title: "Review automation", body: "Right job, right tech, right time — 5-star Google reviews on autopilot." },
      { title: "Estimator cheat sheet", body: "AI-assisted bid generation from job notes and photos." },
      { title: "Subcontractor coordination", body: "Auto-schedules drywallers, painters, and inspectors around your crew." },
    ],
    proof: {
  ...
  landscaping: {
    ...
    steps: [
      { title: "Audit", body: "We look at your renewal rate, route density, and proposal turnaround — and price every gap." },
      { title: "Build", body: "Auto-renewals, AI proposal drafts, intake routing, and route optimization installed." },
      { title: "Handover", body: "Trained, owned, off our books." },
    ],
    automations: [
      { title: "Renewal sequence", body: "Multi-touch flow that locks in next-season contracts in fall, not spring." },
      { title: "AI proposal generator", body: "Job notes + property photos in, signed proposal link out — in minutes." },
      { title: "Spring rush intake", body: "AI qualifier sorts price shoppers from real buyers before your phone rings." },
      { title: "Route density optimizer", body: "Recommends crew routes that cut drive time 15–25%." },
      { title: "Upsell engine", body: "Triggers seasonal add-ons (aeration, mulch, leaf cleanup) to the right customers." },
      { title: "Crew time tracking", body: "GPS-verified hours per property — no more guessing at job costing." },
    ],
    proof: {
  ...
  cleaning: {
    ...
    steps: [
      { title: "Audit", body: "We measure no-show rate, churn, and reply time — and quantify what each one costs you." },
      { title: "Build", body: "Confirmations, churn rescue, instant intake, and review flows installed in your booking tool." },
      { title: "Handover", body: "Your office owns it from day one." },
    ],
    automations: [
      { title: "Three-touch confirmation", body: "Cuts no-shows by 60–80% without annoying your clients." },
      { title: "Churn-saver flow", body: "Detects skipped cleans and triggers a personal save offer before the cancel email." },
      { title: "Instant intake bot", body: "Quotes, qualifies, and books new clients in under five minutes — even at 11pm." },
      { title: "Post-clean review engine", body: "Routes happy clients to Google, unhappy clients straight to you." },
      { title: "Recurring upsell", body: "Adds seasonal deep-cleans, windows, and carpets to the right route." },
      { title: "Supply + payroll dashboard", body: "Real numbers on cost-per-clean, per-crew, per-route." },
    ],
    proof: {
  ...
  "property-management": {
    ...
    steps: [
      { title: "Audit", body: "We map your tenant, owner, and vendor flows and find every coordination gap." },
      { title: "Build", body: "AI triage, owner reports, renewal nudges, and listing automations installed in your stack." },
      { title: "Handover", body: "Property managers trained and shipping in one week." },
    ],
    automations: [
      { title: "Maintenance triage AI", body: "Categorizes, prioritizes, and routes requests to the right vendor 24/7." },
      { title: "Owner reporting engine", body: "Auto-generates monthly statements and portfolio summaries — no spreadsheets." },
      { title: "Renewal pipeline", body: "Tracks every lease end date, nudges tenants 90/60/30 days out, surfaces at-risk units." },
      { title: "Listing + showing automator", body: "Syndicates listings, schedules showings, and pre-qualifies leads before you call back." },
      { title: "Vendor SLA monitor", body: "Auto-escalates jobs that miss promised completion windows." },
      { title: "Rent collection follow-up", body: "Multi-channel polite-to-firm cadence that recovers more, faster." },
    ],
    proof: {
      headline: "A 600-door PM company cut maintenance response time from 18 hours to under 90 minutes.",
  ...
  "real-estate": {
    ...
    steps: [
      { title: "Audit", body: "We trace your lead-to-closed-deal funnel and price every place a lead can fall out." },
      { title: "Build", body: "AI lead nurture, listing pipelines, and TC workflows installed across your stack." },
      { title: "Handover", body: "You own everything. Your TC can run it solo." },
    ],
    automations: [
      { title: "Lead nurture brain", body: "Personalized SMS + email cadence tuned to lead source, price band, and timeline." },
      { title: "Past-client touch system", body: "Quarterly check-ins, anniversary notes, and market updates without you lifting a finger." },
      { title: "Listing launch playbook", body: "From signed agreement to live MLS + social + email in under 24 hours." },
      { title: "Showing feedback loop", body: "Auto-requests feedback from buyer agents and summarizes it for the seller." },
      { title: "Transaction coordinator OS", body: "Every deal, every milestone, every doc — tracked and nudged automatically." },
      { title: "Sphere CRM hygiene", body: "Keeps your database clean, tagged, and segmented without manual upkeep." },
    ],
    proof: {
